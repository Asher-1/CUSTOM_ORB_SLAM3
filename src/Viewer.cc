...
void Viewer::CreatePanel()
{
    ...
    menuStop = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Stop",false,false));
    ...
    menuShowOptLba = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Show LBA opt", false, true));
